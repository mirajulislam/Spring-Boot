...
public class Product {
	...
	public Product(int pro_id, String pro_name, String pro_pre_price, String pro_past_price, String pro_images,
			String pro_total, String pro_description, Date pro_insert_date, Date pro_update_date, Date pro_deleteDate,
			boolean pro_active, Product_Category product_Category) {
		this.pro_id = pro_id;
